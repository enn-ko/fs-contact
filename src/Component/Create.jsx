...
const Create = () => { 
  ...
  const apiCreateContacts = async(contact)=>{
  ...
  const handleSubmit = e =>{
    ...
    // console.log(contact);
    apiCreateContacts(contact)
    navigate('/')
  }
  return (
    <form onSubmit={handleSubmit} action="" className='mx-auto rounded mt-20 w-96 py-5 border-2 shadow-lg p-5'>
      <h1 className=' text-gray-700 text-2xl font-bold text-center'>Create New Contact</h1>
    <div className=''>
      ...
      <div className="relative">
        ...
        className="bg-gray-50 border border-gray-300
         ...
         placeholder="Bonny Crew" required/>
      </div>
      ...
      <div className="relative">
        ...
        value={email}
        type="email" id="email-address-icon" 
      ...
      <div className="relative">
        ...
        <input onChange={(e)=>{setPhone(e.target.value)}} type="phone" id="email-address-icon"
         className="bg-gray-50 border border-gray-300 
         ...
         dark:placeholder-gray-400 dark:text-white 
         dark:focus:ring-blue-500 dark:focus:border-blue-500"
         placeholder="0913795739" required/>
      </div>
